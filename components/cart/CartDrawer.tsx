        ...
        <>
          ...
          >
            ...
            <div className="border-t border-white/70 px-5 pt-4">
              ...
              <Link href="/checkout" onClick={close} className="mt-2.5 flex min-h-11 items-center justify-center gap-2 rounded-full border border-[#214d2b]/15 bg-[linear-gradient(100deg,#f4efe1,#e7f0df)] px-4 text-[10px] font-semibold uppercase tracking-[.06em] text-[#214d2b] shadow-[0_8px_22px_rgba(33,77,43,.08)] transition hover:-translate-y-0.5 hover:shadow-[0_13px_28px_rgba(33,77,43,.13)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#214d2b]"><PackageCheck size={15}/>Checkout</Link>
            </div>
          </motion.aside>
        </>
      ) : null}
