...
export function AddToCartButton({ slug, label = "Add to Cart" }: { slug: string; label?: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-3 bg-ink px-6 py-4 text-sm text-paper shadow-[0_18px_44px_rgba(33,25,21,0.16)] transition hover:-translate-y-0.5 hover:shadow-[0_22px_60px_rgba(33,25,21,0.2)]"
    >
