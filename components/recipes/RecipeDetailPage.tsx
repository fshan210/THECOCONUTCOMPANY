...
export function RecipeDetailPage({ recipe }: { recipe: RecipeItem }) {
  ...
  const saved = savedRecipes.saved.has(recipe.slug);
  ...
  const toggleSave = () => void savedRecipes.toggle(recipe.slug);
