    ...
    <div className={`group/brand-image relative w-full max-w-full overflow-hidden border border-[var(--co-border)] bg-[var(--co-white)] ${aspectClass[aspect]} ${className}`}>
      {failed ? (
        ...
        <Image
          ...
          className={`${fit === "contain" ? "object-contain p-5 md:p-8" : "object-cover"} ${hoverZoom ? "transition duration-700 ease-out group-hover/brand-image:scale-[1.035]" : ""} ${imageClassName}`}
