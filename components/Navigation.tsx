    ...
    <>
      ...
      >
        <nav className="co-container co-nav-row relative flex min-h-[66px] items-center justify-between gap-2 py-2 lg:min-h-[76px] lg:gap-4 lg:py-3">
          ...
          <div className="hidden items-center gap-6 text-[0.7rem] font-bold uppercase tracking-[0.08em] text-[var(--co-ink)] xl:gap-8 lg:flex">
            {links.map((link) => {
          ...
          <div className="hidden items-center gap-2 lg:flex">
            <Link href="/shop" aria-label="Search products" className="grid h-11 w-11 place-items-center rounded-[24px] text-[var(--co-ink)] transition hover:bg-[var(--co-white)] focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-[rgba(244,201,93,0.72)]">
              <Search size={20} />
            </Link>
            {session ? (
              <Link
          ...
          <div className="flex shrink-0 items-center gap-1.5 lg:hidden">
            <Link href="/shop" aria-label="Search products" className="grid h-11 w-11 place-items-center rounded-[24px] text-[var(--co-ink)] focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-[rgba(244,201,93,0.72)]">
