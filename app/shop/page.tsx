    ...
    <>
          ...
          {shopProducts.map((product, index) => (
            <Reveal key={product.slug} delay={index * 0.05}>
              <Link
                ...
                className="group co-neu co-soft-depth-hover block p-4"
              >
      ...
      <section className="bg-paper px-5 py-20 md:px-8">
        <div className="co-glass mx-auto flex max-w-7xl flex-col justify-between gap-6 p-6 md:flex-row md:items-center md:p-8">
          ...
          <Link href="/shop/co-water" className="co-button-soft inline-flex items-center gap-3 bg-ink px-6 py-4 text-sm text-paper">
