...
export default function ResetPasswordPage() { return <><StructuredData breadcrumbs={[{ name: "Home", path: "/" }, { name: "New password", path: "/reset-password" }]} /><AuthShell variant="reset" eyebrow="A brighter return" title={<>Choose a new<br/><em>password.</em></>} description="Use the six-digit code from your email, then choose a strong new password."><Suspense fallback={null}><CustomerResetPasswordForm/></Suspense></AuthShell></>; }
